// 02Notes.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
class NoteParser {
	Naming translator;
public:
	NoteName translator(const std::string& noteText) const {
...
int main()
{
	...
	while (std::cin >> noteText && noteText != "end") {
		NoteName note = parser.translator(noteText);
