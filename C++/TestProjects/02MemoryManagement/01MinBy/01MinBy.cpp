...
bool moreThankBySize(const std::string & a, const std::string & b) {
	return a.size() > b.size();
}
...
int main()
{
	...
	int minCharacteristc = readWhitespaceSeparatedValuesLine()[0][0] - '0';

	switch (minCharacteristc)
	{
	case 1:
	...
	case 2:
		...
		break;
	case 3:
		std::cout << minBy(values, moreThankBySize) << std::endl;
		break;
	default:
		break;
	}
